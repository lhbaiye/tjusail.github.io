...
if __name__ == '__main__':
    ...
    base_model_model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
    ...
    for index, row in result.iterrows():
        ...
        if s_r_c.version == 0:
            ...
            save_data_path = './data/{}-{}-{}'.format(s_r_c.version, drop_col_number, drop_col_name)
